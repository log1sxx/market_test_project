...
class _ApiClient implements ApiClient {
  _ApiClient(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://bxtest.dfa-media.ru';
  }
  ...
  Future<BannersDTO> getBanners() async {
    ...
    final _options = _setStreamType<BannersDTO>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/udachny/banners.json',
    ...
    late BannersDTO _value;
    try {
      _value = BannersDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
